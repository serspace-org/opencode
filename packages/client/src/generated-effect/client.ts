...
type Endpoint12_0Request = Parameters<RawClient["server.autocomplete"]["autocomplete.providers"]>[0]
type Endpoint12_0Input = { readonly location?: Endpoint12_0Request["query"]["location"] }
const Endpoint12_0 = (raw: RawClient["server.autocomplete"]) => (input?: Endpoint12_0Input) =>
  raw["autocomplete.providers"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint12_1Request = Parameters<RawClient["server.autocomplete"]["autocomplete.search"]>[0]
type Endpoint12_1Input = {
  ...
  readonly trigger: Endpoint12_1Request["query"]["trigger"]
  readonly query: Endpoint12_1Request["query"]["query"]
  readonly sessionID?: Endpoint12_1Request["query"]["sessionID"]
}
const Endpoint12_1 = (raw: RawClient["server.autocomplete"]) => (input: Endpoint12_1Input) =>
  raw["autocomplete.search"]({
    query: {
...
const adaptGroup12 = (raw: RawClient["server.autocomplete"]) => ({
  providers: Endpoint12_0(raw),
  search: Endpoint12_1(raw),
})
